import { Convert, TimeConversions } from '../../lib/utils/conversion'
...
describe('Conversions', function () {
	...
	it('should convert the value from hours to ms', function () {
		let expected: number =
			TimeConversions.MINUTES_IN_HOUR *
			TimeConversions.SECONDS_IN_MINUTE *
			TimeConversions.MS_IN_SECOND
		expect(Convert.fromHours(value)).toEqual(value * expected)
	})

	it('should convert the value from days to ms', function () {
		let expected: number =
			TimeConversions.HOURS_IN_DAY *
			TimeConversions.MINUTES_IN_HOUR *
			TimeConversions.SECONDS_IN_MINUTE *
			TimeConversions.MS_IN_SECOND
